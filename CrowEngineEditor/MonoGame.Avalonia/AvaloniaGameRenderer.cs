...
namespace CrowEngineUI;
    ...
    public class AvaloniaGameRenderer
    {
        ...
        private Microsoft.Xna.Framework.Point VirtualResolution
        {
        ...
        private Microsoft.Xna.Framework.Point Resolution
        {
            get => _resolution;
            set
            {
        ...
        private Microsoft.Xna.Framework.Color ClearColor { get; set; } = Microsoft.Xna.Framework.Color.CornflowerBlue;
